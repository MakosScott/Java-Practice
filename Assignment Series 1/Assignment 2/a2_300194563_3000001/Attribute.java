...
public class Attribute {
	...
	public Attribute(String name, int absoluteIndex, AttributeType type, String[] values) {
		...
		String[] copy_of_array = new String[values.length];

		for (int i = 0; i < values.length; i++) { 
			copy_of_array[i] = values[i];
		}

		this.name = name;
		this.absoluteIndex = absoluteIndex;
		this.type = type;
		this.values = copy_of_array; 
	}
	...
	public void replaceValues(String[] newValues) {
		// WRITE YOUR CODE HERE!
		String[] copyArray = newValues.clone();
		this.values = copyArray; 
	}
	...
	public Attribute clone() {
		// WRITE YOUR CODE HERE!
		String[] deepClone = new String[values.length];

		for (int i = 0; i < values.length; i++) { 
			deepClone[i] = values[i];
		}

		Attribute deepCloneAttribute = new Attribute(this.name, this.absoluteIndex, this.type, deepClone);
