...
public class ParkingLot {
	...
	public int getTotalOccupancy() {
		...
		for (int i = 0; i < numRows; i++) {
			for (int x = 0; x < numSpotsPerRow; x++) {
				if (WtvYouDecide[i][x] != "N")
					counter++;
			}
	...
	public static void main(String args[]) throws Exception {
		...
		File file = new File("parking.inf");
		...
		// System.out.println(lot.getTotalCapacity());
		// System.out.println(lot.getTotalOccupancy());
